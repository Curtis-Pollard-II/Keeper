...
namespace Keeper.Services
{
    public class VaultKeepsService
    {
        ...
        public VaultKeepsService(VaultKeepsRepository vKRepo, VaultsService vService, KeepsService kService, VaultsRepository vRepo, KeepsRepository kRepo)
        {
            _VKRepo = vKRepo;
            _vService = vService;
            _kService = kService;
